...
Vendored from GoogleCloudPlatform/dataplex-labs
(knowledge_catalog_discovery_agent) so it can be deployed as a standalone
service alongside the Business User Interface. See agent_service/README.md.
"""
...
def knowledge_catalog_multi_search(
  ...
  with concurrent.futures.ThreadPoolExecutor(
    ...
    # Retrieve and process search results from each parallel execution.
...
def _deduplicate_and_fetch_context(
  ...
  # Interleave and deduplicate round-robin style to preserve relevance order.
